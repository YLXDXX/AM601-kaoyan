...
\item
$\int \frac{d x}{1+\sqrt[3]{x+2}}=$ \tk{$\frac{3}{2}(x+2)^{\frac{2}{3}}-3(x+2)^{\frac{1}{3}}+3 \ln (1+\sqrt[3]{x+2})+C$} 。
...
\banswer{
	$\varphi^{\prime}(x)=\frac{x e^{x} f(x)+x e^{x} f^{\prime}(x)-e^{x} f(x)}{x^{2}}$
}
...
\banswer{
	$y=C_{1}+\left(C_{2}+C_{3} \ln x\right) x^{2}-\frac{1}{36}$
}
